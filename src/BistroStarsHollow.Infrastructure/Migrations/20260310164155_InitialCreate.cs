    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BistroTables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoImagePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CashAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "cs"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayPrice = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffOnDuty", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BistroTables_IsActive",
                table: "BistroTables",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Breweries_IsActive",
                table: "Breweries",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_CashClosures_Date",
                table: "CashClosures",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_Key_Language",
                table: "ContentBlocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryImages_IsActive",
                table: "GalleryImages",
                column: "IsActive");
